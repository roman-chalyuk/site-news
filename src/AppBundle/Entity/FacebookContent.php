...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\FacebookContentRepository")
 * @ORM\Table(name="facebook_content")
 */
class FacebookContent
{
     ...
     * @ORM\JoinTable(name="facebook_user")
     */
    private $users;
     ...
     * @ORM\JoinTable(name="facebook_domain")
     */
    private $domains;
     ...
     * @ORM\JoinTable(name="facebook_sitepage")
     */
    private $pages;
     ...
     * @ORM\JoinTable(name="facebook_language")
     */
    private $languages;
